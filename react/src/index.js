...
class App extends Component {
  constructor() {
    ...
    // as headers to the backend, we need to make sure we are calling `scope.setTag()`
    // on the current scope (https://docs.sentry.io/platforms/javascript/enriching-events/scopes/#current-scope). 
    // We don't want to call Sentry.setTag() directly as is usually
