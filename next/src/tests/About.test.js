...
// Mock employees data
jest.mock('../components/employees/jane', () => ({
  name: 'Jane',
  img: 'jane.jpg',
  url: 'jane-url',
}));
jest.mock('../components/employees/lily', () => ({
  name: 'Lily',
  img: 'lily.jpg',
  url: 'lily-url',
}));
jest.mock('../components/employees/keith', () => ({
  name: 'Keith',
  img: 'keith.jpg',
  url: 'keith-url',
}));
jest.mock('../components/employees/mason', () => ({
  name: 'Mason',
  img: 'mason.jpg',
  url: 'mason-url',
}));
jest.mock('../components/employees/emma', () => ({
  name: 'Emma',
  img: 'emma.jpg',
  url: 'emma-url',
}));
jest.mock('../components/employees/noah', () => ({
  name: 'Noah',
  img: 'noah.jpg',
  url: 'noah-url',
}));
