...
1. Permit your IP address in CloudSQL:
   ...
   3. Expand "Connections". By default you'll be in the Summary tab. Navigate to the Networks tab. under Authorized Networks click "ADD NETWORK"
   5. Google "my IP address", add it.
