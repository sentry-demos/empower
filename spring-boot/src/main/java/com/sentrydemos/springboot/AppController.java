...
public class AppController {
	...
	public String Success(HttpServletRequest request) {
		...
		setTags(request);
		return "success from spring-boot";
	...
	public String Api(HttpServletRequest request) {
		logger.info("[spring-boot - logback] - > /api");
		setTags(request);

		Sentry.logger().info("[spring-boot] - Making external API call to Ruby backend");
		...
		Sentry.logger().info("[spring-boot] - External API call completed", "response_status", response.getStatusCode().value());
	...
	public String Organization(HttpServletRequest request) {
		setTags(request);
		return "spring-boot /organization";
	}

	@CrossOrigin
	@GetMapping("/logback")
	public String Logback() {
		logger.info("[spring-boot - logback] - info log");
		logger.warn("[spring-boot - logback] - warn log");
		logger.error("[spring-boot - logback] - error log");
